<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ASP_project.index" %>
              ...
              internships, entry-level roles, and growth opportunities.
                ...
                <form class="search-bar" aria-label="Job search form">
                    <div class="search-field">
                        ...
                        <asp:TextBox runat="server" id="keyword" placeholder="e.g. UI Designer, Data Analyst"></asp:TextBox>
<%--                        <input type="text" id="keyword" placeholder="e.g. UI Designer, Data Analyst" />--%>
                    </div>
                    <div class="search-field">
                        <label for="location">Location</label>
                        <asp:TextBox runat="server" id="location" placeholder="City or remote"></asp:TextBox>
<%--                        <input type="text" id="location" placeholder="City or remote" />--%>
                    </div>
                    <asp:Button runat="server" Text="submit" class="btn btn-primary search-btn" />
            ...
            <div class="container nav-wrap">
                ...
                <nav class="main-nav" aria-label="Main navigation">
                    <ul>
                        ...
                        <li><a href="Find_Jobs.aspx">Find Jobs</a></li>
