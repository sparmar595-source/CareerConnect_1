  ...
  <body>
    <div class="auth-shell">
      <header class="auth-header">
        <a href="index.aspx" class="brand" aria-label="CareerConnect home">
      ...
      <form class="auth-form">
        <div class="form-grid">
          ...
          <div class="form-inline">
              <asp:Label ID="Label3" runat="server" type="checkbox" Text="Remember me"></asp:Label>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" /><title>CareerConnect | Online Job & Internship Portal</title>
        <meta
      name="description"
      content="CareerConnect helps students and job seekers discover internships, jobs, and opportunities with top employers."
    />
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
        <link
    ...
    />
      ...
      integrity="sha512-DTOQO9RWCH3ppGqcWaEA1BIZOC6xxalwUEQp1b9Dk1JwQJQmUQ5gFQ=="
    ...
    <body>
        <header class="site-header">
            <div class="container nav-wrap">
                <a href="index.html" class="brand" aria-label="CareerConnect home"><span class="brand-mark">C</span> <span>CareerConnect</span> </a>
                ...
                <nav class="main-nav" aria-label="Main navigation">
                    <ul>
                        ...
                        <li><a href="signup.html" class="btn btn-primary btn-small">Sign Up</a></li>
                    </ul>
                </nav>
            </div>
        </header>--%>
    ...
    <%--<footer class="site-footer" id="about">
        <div class="container footer-grid">
            <div>
                ...
                <p>
                    CareerConnect helps students, job seekers, and employers build better career opportunities
            through smarter matches and cleaner hiring experiences.
                </p>
            </div>
            <div>
                <h3>Quick Links</h3>
            ...
            <div>
                <h3>Contact</h3>
                <ul class="footer-links">
                    <li><a href="mailto:hello@careerconnect.com">hello@careerconnect.com</a></li>
                    <li><a href="tel:+18005551234">+1 (800) 555-1234</a></li>
                    <li>45 Market Street, New York</li>
                </ul>
            </div>
            <div>
                <h3>Follow Us</h3>
                <div class="social-icons">
                    <a href="#" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a><a href="#" aria-label="X"><i class="fa-brands fa-x-twitter"></i></a><a href="#" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a><a href="#" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
                </div>
            </div>
        </div>
        <div class="container footer-bottom">
            <p>
                © 2026 CareerConnect. All rights reserved.</p>
        </div>
    </footer>
  </body>
</html>--%>
